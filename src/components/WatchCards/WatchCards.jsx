  ...
  const handleDirection = (direction) => {
    ...
    if (direction === "left" && sliderPosition > 0) {
      if (sliderPosition === 1) {
        ...
        listRef.current.style.transform = `translateX(${sliderPosition * -distance
          }px)`;
      }
    ...
    if (direction === "right" && sliderPosition < actualData.length - 1) {
      ...
      if ((nextPosition + 1) * distance > listRef.current.offsetWidth) {
        ...
        listRef.current.style.transform = `translateX(${-nextPosition * distance
          }px)`;
      }
    ...
    <>
      ...
      >
        <div className="wrapper">
          <div
            className={`slider-action left ${sliderPosition === 0 ? "none" : ""
              }`}
          >
            <AiOutlineLeft
          ...
          <div
            className={`slider-action right ${sliderPosition >= actualData.length - 2 ? "none" : ""
              } `}
          >
            <AiOutlineRight
