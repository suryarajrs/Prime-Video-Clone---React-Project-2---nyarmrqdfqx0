...
import RelatedMovies from "../Episodes/RelatedMovies";
import { ShowDetails } from "../ShowDetails/ShowDetails";
import Loader from "../Loader/Loader";
import {Series_Episodes} from "../Episodes/Series_Episodes.jsx"
...
const WatchDetails = () => {
  ...
  const handleShowDetials = () => {
    {isMobile?( navigate(`/watchDetailsMob/${id}`)):(navigate(`/TVShow/${id}`))}
   ;
  };

  const watchlistUpdateAPI =  "https://academics.newtonschool.co/api/v1/ott/watchlist/like";
                ...
                <div className="watchDetails-btn-options-container">
                  ...
                  <span className="home-play-btn-container-new trailer-span">
                    <Tooltip title="Watchlist" placement="bottom" arrow={false}>
                      <span>
                        {(isloggedIn && !isInWatchList) || !addtowatchlist || !isInWatchList ? (
                          <span>
                            <AiOutlinePlus
